...
public class Valadoc.IndexGenerator : Valadoc.ValadocOrgDoclet {
	...
	private void load_metadata (string filename) {
		Vala.MarkupReader reader = new Vala.MarkupReader (filename);
	...
	private void load_images_gir (Package pkg) {
		...
		Vala.MarkupTokenType token = Vala.MarkupTokenType.EOF;
		Vala.SourceLocation token_begin;
		Vala.SourceLocation token_end;
	...
	//private void xml_warning (Vala.MarkupReader reader, Vala.MarkupTokenType current_token, Vala.SourceLocation begin, Vala.SourceLocation end, string message) {
